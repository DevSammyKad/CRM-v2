        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex items-center gap-4">
              <img
                className="rounded-full w-11 flex justify-center items-center mx-2 "
                src={Logo}
                alt="Logo"
              />
              ...
              <form action="#" method="GET" className="hidden lg:block lg:pl-2">
                ...
                <div className="relative mt-1 lg:w-96">
                  ...
                  <input
                    ...
                    name="email"
                    id="topbar-search"
                    className="bg-gray-50 border border-border-stroke text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-b-gray-light block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search"
                  />
                </div>
              </form>
                  ...
                  >
                    ...
                    <div className="pl-3 w-full">
                      <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                        ...
                        posted a new video: GlassnclassNamemorphism - learn how
